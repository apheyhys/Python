...
class Application(Frame):
    ...
    def tell_story(self):
        """Заполняет тектовую область очередной историей на основе пользовательского ввода."""
        ...
        story += noun
        story += " и "
        story += person + " столкнулить лицом к лицу. "
        story += "Мощное, "
        story += adjectives
