# Законсервируем
# Демонтстрирует консервацию данных и доступ к ним через интерфейс полки
...
f = open("textfiles/pickles1.dat", "wb")
pickle.dump(variety, f)
pickle.dump(shape, f)
pickle.dump(brand, f)
f.close()
print("\nРасконсервация списков.")
f = open("textfiles/pickles1.dat", "rb")
...
s = shelve.open("textfiles/pickles2.dat")
